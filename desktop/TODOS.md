...
- >=2h native resource soak with GitHub + WORKS + Agent Bridge connected — analyzer + falsification tests implemented; closure still requires a real >=2h receipt, exact executable/source provenance, complete connector evidence and manual trend review.
